 ...
 * @param {string} method - Misalnya: "GET", "POST", "PUT", "DELETE"
...
export const apiFetch = async (endpoint, method = "GET", body = null, isFile = false) => {
    ...
    const options = {
        method,
        headers,
        // Stringify body hanya jika bukan file dan body ada
        body: (body && !isFile && typeof body === 'object') ? JSON.stringify(body) : body,
    };
