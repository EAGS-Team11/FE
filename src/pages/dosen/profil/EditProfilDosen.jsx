/* src/pages/dosen/profil/EditProfilDosen.jsx */
...
export default function EditProfilDosen() {
  ...
  return (
    <div className="max-w-5xl mx-auto font-inter py-15">
      ...
      <div className="bg-white rounded-md shadow-md border border-gray-200">
        ...
        <div className="bg-[#f3f5f9] px-4 py-2 flex justify-between items-center rounded-t-md mb-10">
